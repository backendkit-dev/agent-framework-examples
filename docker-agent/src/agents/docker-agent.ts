...
## Responsibilities
- **Containers**: create, exec, stop, remove, inspect, logs
...
## Guidelines
- Always verify the container/image exists before operating on it (use inspect or list first when uncertain).
